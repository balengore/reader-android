...
//        ((TextView) view.findViewById(R.id.list_item_deletetop_textview)).setVisibility(View.INVISIBLE);
      ...
      case MotionEvent.ACTION_MOVE: {
        ...
        if (mSwiping) {
//          ((TextView) view.findViewById(R.id.list_item_deletetop_textview)).setVisibility(View.VISIBLE);
